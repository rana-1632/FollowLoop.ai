...
import { getIsolationScope, getDefaultIsolationScope, logger, captureException, getClient, spanToJSON, SEMANTIC_ATTRIBUTE_SENTRY_OP, SEMANTIC_ATTRIBUTE_SENTRY_ORIGIN } from '@sentry/core';
...
class SentryGlobalGraphQLFilter {
   static  __initStatic() {this._logger = new Logger('ExceptionsHandler');}
...
export { SentryGlobalFilter, SentryGlobalGenericFilter, SentryGlobalGraphQLFilter, SentryModule, SentryService, SentryTracingInterceptor };
